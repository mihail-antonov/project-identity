          ...
          <div className={styles.mainwrapper}>
            <div className="home-title-content">
              <div className={styles.titleavatar}>
                <Image src="/img/avatar.png" alt="hi" className={styles.titleavatarimg} width="480px" height="480px" />
              </div>
              <div className={styles.titletextbox}>
                <p className={utilStyles.titlesubheading}>Hey, I'm Mihail 👋</p>
                <h2 className={utilStyles.titleheading}>Frontend developer based in Bulgaria</h2>
                <p className={utilStyles.titlesubtext}>Frontend developer who specializes in creating UI/UX design and coding e-commerce themes for different content management systems. Basicly <span className={utilStyles.titlehighlight}>Everthing</span> for you online shop</p>
                <Link href="/contact">
                  <button className={utilStyles.calltoaction}>Contact me</button>
                </Link>
              </div>
            </div>
          </div>
