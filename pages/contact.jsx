          ...
          <div className={styles.mainwrapper}>
            <div className="contact-title-content">
              ...
              <div className={styles.titletextbox}>
                <h2 className={utilStyles.titleheading}>Hello! I've been waiting for you.</h2>
                <p className={utilStyles.titlesubtext}>Fill in the contact form or <span className={utilStyles.titlehighlight}>Send me an email</span></p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className={styles.mainwrapper}>
              ...
              <div className="contact-info">
                ...
                <form noValidate autoComplete="off">
                  <TextField id="standard-basic" label="Your name" placeholder="What's your name?"/>
                  <TextField id="standard-basic" label="Your email" placeholder="And your email?"/>
                </form>
              </div>
